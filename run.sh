...
#MODELS=( qwen2:0.5b qwen2:1.5b gemma2:2b phi3:3.8b mistral:7b qwen2:7b llama3.1:8b gemma2:9b mistral-nemo:12b phi3:14b gemma2:27b llama3.1:70b qwen2:72b mistral-large:123b )
